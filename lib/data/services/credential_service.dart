...
/// ("Service — one per external data source, stateless"): the secure
/// storage that holds the cached credential and its display fields.
///
/// 015: the credential-status call went with the invented contract. The
/// real status comes from `GET /v1/identity/me`
...
class CredentialService {
  CredentialService({required FlutterSecureStorage secureStorage})
